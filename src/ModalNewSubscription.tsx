  ...
  return (
    <div className="w-full h-full flex flex-col justify-evenly items-center my-2">
      ...
      <fieldset className="flex flex-col justify-between items-center">
        ...
        <button className="w-fit bg-black border-2 rounded-md px-2 py-1 mt-3 mb-6 border-black text-white hover:bg-white hover:text-black hover:cursor-pointer " onClick={handleNewSubscription}>
          Ajouter
        </button>
      </fieldset>
