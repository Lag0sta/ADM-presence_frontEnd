    ...
    <div className="w-full h-full flex justify-evenly items-center ">
      ...
      {!auth.token &&
        <div className=" flex items-center bg-[#FFCB00] border-2 border-[#FFCB00]  rounded-full p-2 border-[#FFCB00] hover:bg-white ">
          <span className="xxxs:px-2 xxxs:py-1 xxxs:text-xl xxs:px-3 xxs:py-2 xxs:text-3xl  font-cascadiaCode font-semibold text-white cursor-pointer hover:text-[#FFCB00]" onClick={handleSignIn}>Connexion</span>
        </div>
      }
      {auth.token &&
