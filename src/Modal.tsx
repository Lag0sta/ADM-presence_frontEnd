...
function Modal({ handleModalAction, handleMsgModalAction, setComponent, studentSubscription, setStudentSubscription, studentFile, setStudentFile }: props) {
  ...
  return (
    <div className=" fixed inset-0 flex items-center justify-center z-20 "
      ...
      <div className=" bg-[#FFCB00] rounded-lg z-50">
        <div className=" flex flex-col items-center">
          <div className="w-full flex justify-end mr-4" onClick={handleCloseModal}>
            <svg className="portrait:xxxs:size-11 portrait:xxxs:mt-3 xxxs:size-10 landscape:xxxs:mr-3 landscape:xxxs:mt-2 landscape:md:size-11 landscape:md:mr-3 landscape:md:mt-2 xxs:size-12 xxs:mr-3 xxs:mt-2 sm:size-12 sm:mr-3 sm:mt-2 2xl:size-14 2xl:mr-5 2xl:mt-5   hover:fill-white hover:cursor-pointer "
